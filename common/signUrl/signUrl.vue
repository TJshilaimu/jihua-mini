<template>
	<view class="wrapper">
		<view class="handBtn">
<!-- 			<image @click.stop="selectColorEvent" :src="selectColor === 'black' ? blackImg : blackImgSelcected" :class="selectColor === 'black' ? 'color_select' : ''"
			 class="black-select" data-color="black" data-color-value="#1A1A1A"></image>
			<image @click.stop="selectColorEvent" :src="selectColor === 'red' ? redImg : redImgSelcected" :class="selectColor === 'red' ? 'color_select' : ''"
			 class="red-select" data-color="red" data-color-value="#ca262a"></image> -->
			<button @click.stop="retDraw" class="delBtn">重写</button>
			<!-- <button @click.stop="subCanvas" class="subBtn">完成</button> -->
			<!-- <button @click.stop="saveCanvasAsImg" class="saveBtn">保存</button> -->
			<!-- <button @click.stop="previewCanvasImg" class="previewBtn">预览</button> -->
			<!-- <button @click.stop="uploadCanvasImg" class="uploadBtn">上传</button> -->
			<button @click.stop="subCanvas" class="subBtn">完成</button>
		</view>
	...
	export default {
		...
		methods: {
			...
			subCanvas() {
				...
				uni.navigateTo({
					url:'../../pages/project/signResult/signResult'
				})
			},
