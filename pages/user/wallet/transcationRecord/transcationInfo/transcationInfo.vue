<template>
	<view>
		...
		<view class="items">
			...
			<view class="item"><text>交易类型</text><text>{{orderInfo.type=='3'?'项目款':''}}</text></view>
			<view class="item"><text>打款进度</text>
				<view class="phase">
					<u-time-line>
							<u-time-line-item nodeTop="2">
								...
								<template v-slot:content>
									<view>
										<view class="u-order-title">打款中</view>	
							...
							<u-time-line-item>
								...
								<template v-slot:content>
									<view>
										<view class="u-order-title">打款完成</view>
